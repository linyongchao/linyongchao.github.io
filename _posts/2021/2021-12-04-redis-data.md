...
本文来源：[这里](https://mp.weixin.qq.com/s/MGcOl1kGuKdA7om0Ahz5IA)
...
![](https://linyongchao.github.io/static/img/redis/data1.webp)
...
这次，小林把新旧版本的数据结构图解一遍，共有 9 种数据结构：SDS、双向链表、压缩列表、哈希表、跳表、整数集合、quicklist、listpack。

![](https://linyongchao.github.io/static/img/redis/data2.webp)
...
![](https://linyongchao.github.io/static/img/redis/data3.webp)
...
![](https://linyongchao.github.io/static/img/redis/data4.webp)
...
![](https://linyongchao.github.io/static/img/redis/data5.webp)
...
![](https://linyongchao.github.io/static/img/redis/data6.webp)
...
![](https://linyongchao.github.io/static/img/redis/data7.webp)
...
![](https://linyongchao.github.io/static/img/redis/data8.webp)
...
![](https://linyongchao.github.io/static/img/redis/data9.webp)
...
![](https://linyongchao.github.io/static/img/redis/data10.webp)
...
![](https://linyongchao.github.io/static/img/redis/data11.webp)
...
![](https://linyongchao.github.io/static/img/redis/data12.webp)
...
![](https://linyongchao.github.io/static/img/redis/data13.webp)
...
![](https://linyongchao.github.io/static/img/redis/data14.webp)
...
![](https://linyongchao.github.io/static/img/redis/data15.webp)
...
![](https://linyongchao.github.io/static/img/redis/data16.webp)

因为这些节点长度值小于 254 字节，所以 prevlen 属性需要用 1 字节的空间来保存这个长度值。

这时，如果将一个长度大于等于 254 字节的新节点加入到压缩列表的表头节点，即新节点将成为 e1 的前置节点，如下图：

![](https://linyongchao.github.io/static/img/redis/data17.webp)

因为 e1 节点的 prevlen 属性只有 1 个字节大小，无法保存新节点的长度，此时就需要对压缩列表的空间重分配操作，并将 e1 节点的 prevlen 属性从原来的 1 字节大小扩展为 5 字节大小。

多米诺牌的效应就此开始。

![](https://linyongchao.github.io/static/img/redis/data18.webp)
...
![](https://linyongchao.github.io/static/img/redis/data19.webp)
...
![](https://linyongchao.github.io/static/img/redis/data20.webp)
...
![](https://linyongchao.github.io/static/img/redis/data21.webp)
...
![](https://linyongchao.github.io/static/img/redis/data22.webp)
...
![](https://linyongchao.github.io/static/img/redis/data23.webp)
...
![](https://linyongchao.github.io/static/img/redis/data24.webp)
...
![](https://linyongchao.github.io/static/img/redis/data25.webp)

现在，往这个整数集合中加入一个新元素 65535，这个新元素需要用 int32_t 类型来保存，所以整数集合要进行升级操作，首先需要为 contents 数组扩容，在原本空间的大小之上再扩容多 80 位（4x32-3x16=80），这样就能保存下 4 个类型为 int32_t 的元素。

![](https://linyongchao.github.io/static/img/redis/data26.webp)

扩容完 contents 数组空间大小后，需要将之前的三个元素转换为 int32_t 类型，并将转换后的元素放置到正确的位上面，并且需要维持底层数组的有序性不变，整个转换过程如下：

![](https://linyongchao.github.io/static/img/redis/data27.webp)
...
![](https://linyongchao.github.io/static/img/redis/data28.webp)
...
![](https://linyongchao.github.io/static/img/redis/data29.webp)
...
![](https://linyongchao.github.io/static/img/redis/data30.webp)
...
![](https://linyongchao.github.io/static/img/redis/data31.webp)
...
![](https://linyongchao.github.io/static/img/redis/data32.webp)
...
![](https://linyongchao.github.io/static/img/redis/data33.webp)
...
![](https://linyongchao.github.io/static/img/redis/data34.webp)

listpack 头包含两个属性，分别记录了 listpack 总字节数和元素数量，然后 listpack 末尾也有个结尾标识。图中的 listpack entry 就是 listpack 的节点了。

每个 listpack 节点结构如下：

![](https://linyongchao.github.io/static/img/redis/data35.webp)
